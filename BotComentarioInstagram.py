...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            firefox_profile=firefoxProfile, executable_path=r"C:\Users\Pichau\Downloads\bot_comentarios_instagram-master\geckodriver.exe"
        )
...
viniciusBot = InstagramBot("login", "password")
vinicius.login()
